  ...
  container.innerHTML = `
      ...
      <section class="wrapper">
        <article class="article">
          <h2 class="sub-title">The first Pokémon ever designed </h2>
        ...
        <article class="article">
          <h2 class="sub-title">Pokémon doesn't have a plural </h2>
        ...
        <article class="article">
          <h2 class="sub-title">Slowbro Is The Only Pokemon That Can Devolve</h2>
        ...
        <article class="article">
          <h2 class="sub-title">The gender of a Pikachu can be determined by its tail. </h2>
          <p class="paragraph-article">
        ...
        <article class="article">
          <h2 class="sub-title">Lots of Pokémon names are puns</h2>
          <p class="paragraph-article">
        ...
        <article class="article">
          <h2 class="sub-title">The 'Gotta Catch 'Em All' ethos has a back story</h2>
        ...
        <article class="article">
          <h2 class="sub-title">The colours of the Pokeballs are actually based on Cambell's soup cans </h2>
        ...
        <article class="article">
          <h2 class="sub-title">Ash's Pokémon was originally meant to be a Clefairy, not Pikachu! </h2>
          <p class="paragraph-article">
        ...
        <article class="article">
          <h2 class="sub-title">Over 88 billion Pokémon have been caught on Pokémon Go </h2>
