        ...
        <div class="card-box">
          ...
          <main class="box-poke-text">
            ...
            <ul class="poke-items">
              ...
              <div class="items">
                ${colorItems(item.type)}
              </div>
            </ul>
            <ul class="poke-items">
              <span class="poke-item-title">Fraqueza:</span> 
              <div class="items">
                ${colorItems(item.weaknesses)}
              </div>
            </ul>
          </main>
        </div>
...
function colorItems(values) {
  let items = document.querySelector(".items");
  let list = document.querySelector(".poke-items li");
  for (let i = 0; i <= values.length; i++) {
    let li = document.createElement("li");
    let value = document.createTextNode(values[i]);
